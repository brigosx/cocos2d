...
public class CCParticleExplosion extends CCQuadParticleSystem {
    ...
    public static CCParticleSystem particleWithFile(String plistFile) {
		...
		CCParticleSystem particle = (CCParticleSystem) new CCParticleExplosion();
        ...
        particle.setTexture(CCTextureCache.sharedTextureCache().addImage(textureName));

        if ((particle.getTexture() == null) && (textureData != null)) {
